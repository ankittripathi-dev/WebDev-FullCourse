...
const About = () => {
  return (
    <div className="w-full">
      ...
      {/* ================= ABOUT CARD ================= */}
      <section className="w-full bg-gray-100 dark:bg-gray-700 px-4 py-10 sm:py-14">
        <div
          className="
            w-full
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
            ...
            <div className="flex justify-center w-full md:w-1/3">
              <div className="relative w-28 h-28 sm:w-36 sm:h-36 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-orange-400">
                <Image
            ...
            <div className="w-full md:w-2/3 text-center md:text-left">
              <h1 className="text-xl sm:text-2xl md:text-4xl font-bold text-gray-800 dark:text-white mb-3">
                About Me
              </h1>

              <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed mb-4">
                Hello! I'm Ankit, a passionate software developer and tech
                ...
                here to help others on their path to mastering the art of coding.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-50">
              From curious beginner to seasoned developer, here's how Ankit
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  Ankit’s coding journey began in high school when he stumbled
                  upon his first programming language—Python. What started as a
                  simple curiosity quickly turned into a passion, as Ankit spent
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              ...
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  After mastering the basics, Ankit’s thirst for knowledge grew.
                  He began exploring more complex topics such as data structures,
                  algorithms, and web development. Enrolling in online courses
                  and attending coding bootcamps, Ankit quickly expanded his
                  skill set, taking on freelance projects to apply his knowledge
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  With several years of experience under his belt, Ankit began
                  tackling more significant challenges. From contributing to
                  open-source projects to developing his own applications, Ankit
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              ...
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  Today, Ankit is not only a proficient coder but also a mentor
                  ...
                  development. For Ankit, coding is more than just a
