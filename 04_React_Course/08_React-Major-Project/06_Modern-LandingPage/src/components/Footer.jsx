      ...
      <div className="section-container">
        ...
        >
          ...
          <motion.div 
            ...
            className="lg:col-span-4 ml-25 max-md:ml-2"
          >
            <motion.div 
              variants={fadeIn('down', 0.5)}
              className="flex items-center gap-1 mb-6c"
            >
            ...
            >
              <motion.a 
                ...
                href="#" 
                className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center max-md:ml-25 text-gray-600 hover:bg-blue-600 hover:text-white transition-colors"
              >
          ...
          <motion.div 
            ...
            className="lg:col-span-8 max-md:ml-7"
          >
        ...
        >
          ...
          >
            <motion.p 
              ...
              className="text-gray-600 text-sm ml-25 max-md:ml-1"
            >
              Copyright © {new Date().getFullYear()} TheNextDesign.com
            </motion.p>
            <motion.p 
              variants={fadeIn('left', 1.0)}
              className="text-gray-600 text-sm mr-25 max-md:mr-3"
            >
              Created by <span className='text-black font-medium'>Ankit Tripathi</span>
            </motion.p>
          </motion.div>
        </motion.div>
      </div>
