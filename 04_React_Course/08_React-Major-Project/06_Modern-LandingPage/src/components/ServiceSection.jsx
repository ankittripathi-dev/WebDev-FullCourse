...
const ServicesSection = () => {
  const services = [
    {
      icon: <BsStack className="w-8 h-8 text-[#2cc479]" />,
      title: "Web Design",
  ...
  return (
    <section id="services" className="py-20 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
     <div className='flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24'>
       ...
       className="md:w-1/3">
        ...
        >
          ...
          >
            <div className="w-5 h-5 rounded-full bg-indigo-100 flex items-center justify-center">
              <div className="w-2.5 h-2.5 rounded-full bg-[#2cc479]"></div>
            </div>
        ...
        <button 
          ...
          className="mt-8 bg-[#2cc479] text-white px-8 py-3 cursor-pointer rounded-full hover:bg-green-600 transition-colors"
        >
          Get started
        </button>
      </motion.div>
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <a 
              ...
              href={service.link}
              className="text-[#2cc479] font-medium hover:text-green-600 transition-colors"
            >
              LEARN MORE
            </a>
          </div>
