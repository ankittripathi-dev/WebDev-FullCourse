...
//! (5) Tuple
// Example.1
let arr3: [number, string] = [100, "ankit"];
...
// Example.3
let arr5: [number, object, boolean, string] = [
  1,
  { name: "mahi" },
  true,
  "ankit",
...
// Example.2
function sayHello(a: number, b: string = "onlyOne"): number {
  return 55;
}
sayHello(10); 
...
var result: myName = 100;
var result: myName = "ShaktiMaan";
