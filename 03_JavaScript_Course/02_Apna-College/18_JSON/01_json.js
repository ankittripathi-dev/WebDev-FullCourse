...
console.log(course);         // output:- { name: 'TypeScript', Instructor: 'Harsh', Price: 'Free' }
console.log(typeof course);  // output:- object

// JSON to String
const convertedInStr = JSON.stringify(course);
console.log(convertedInStr);    // output:- '{"name":"TypeScript","Instructor":"Harsh","Price":"Free"}'
console.log(typeof convertedInStr); // output:- string
